  ...
  if ( $get->modulo("cancer-mama-metastasico")) {
    ...
    <div class="content__item">
      ...
      <ol class="listas listas--alfabetico listas--bold listas--secundario-2">
        <!-- a. -->
        <li>
          <p><strong class="frontal frontal--secundario-2">Detección y Diagnóstico de Metástasis</strong></p>
          ...
          <ol class="listas listas--romano">
            <!-- i. -->
            <li>
              <p><strong>Signos Y Síntomas de Metástasis Ósea</strong></p>

              <ol class="listas listas--circulo">
                <li class="text text--justify">Dolor constante en la espalda, los huesos o las articulaciones.</li>
                <li class="text text--justify">Signos y síntomas de metástasis ósea en columna vertebral: Dificultad para orinar (incontinencia o incapacidad de orinar) y/o adormecimiento o debilidad en miembros.</li>
              </ol>
            </li>

            <!-- ii. -->
            <li>
              <p><strong>Signos Y Síntomas de Metástasis Pulmonar</strong></p>

              <ol class="listas listas--circulo">
                <li>Tos seca constante.</li>
                <li>Disnea o dificultad para respirar.</li>
              </ol>
            </li>

            <!-- iii. -->
            <li>
              <p><strong>Signos Y Síntomas de Metástasis Hepática</strong></p>

              <ul class="listas listas--circulo">
                <li>Inflamación, dolor o sensibilidad abdominal.</li>
                <li>Ictericia (coloración amarillenta en la piel y la parte blanca de los ojos).</li>
              </ul>
            </li>

            <!-- iv. -->
            <li>
              <p><strong>Signos Y Síntomas de Metástasis Cerebral</strong></p>

              <ul class="listas listas--circulo">
                <li>Dolor de cabeza intenso.</li>
                <li>Problemas de la vista (visión borrosa, visión doble, pérdida de la visión).</li>
                <li>Convulsiones.</li>
        ...
        <!-- b. -->
        <li>
          <p><strong class="frontal frontal--secundario-2">Estudios Diagnóstico para la Estadificación a Distancia.</strong></p>
        ...
        <li>
          ...
          <p>Van a estar determinadas por:</p>
          <ul class="listas listas--disco listas--secundario-3">
            <li>Tratamiento previo.</li>
            <li>Edad de la paciente, estado menstrual, estado general y estatus funcional.</li>
          ...
          <ol class="listas listas--romano">
            <!-- i. -->
            <li>
              <p><strong>Tratamiento Sistémico. <br>Depende de las características del tumor.</strong></p>
              ...
              <ul class="listas listas--circulo listas--secundario-3">
                <li>
                  ...
                  <ul class="listas listas--disco">
                    <li class="text text--justify">La terapia secuencial con un solo fármaco tiene menor toxicidad que la terapia combinada y es generalmente la principal opción. El uso de regímenes combinados está reservado para pacientes con rápida progresión clínica, metástasis visceral que ponen en riesgo la vida del paciente y cuando se necesita un rápido control de la enfermedad o síntomas.</li>
                ...
                <li>
                  ...
                  <ul class="listas listas--disco">
                    <li class="text text--justify">Tratamiento de elección en pacientes con receptores hormonales positivos. Medicamentos Incluidos en la lista de medicamentos esenciales de la Organización Mundial de Salud (OMS): Tamoxifeno, Anastrozole, Leuprolide.</li>
                  </ul>
                </li>
                ...
                <li>
                  ...
                  <ul class="listas listas--disco">
                    <li class="text text--justify">Terapia anti Her2. Es la terapia de elección para todas las pacientes con cáncer de mama metastásico Her2, a menos que exista alguna contraindicación o el fármaco no esté disponible.</li>
      ...
      <!-- Se reinicia la numeración alfabética -->
      <ol class="listas listas--alfabetico listas--bold listas--secundario-2">
        <!-- a. -->
        <li>
          <p><strong class="frontal frontal--secundario-2">Seguimiento</strong></p>

          <ul class="listas listas--disco listas--secundario-3">
            <li class="text text--justify">Evaluar la respuesta o progresión de la enfermedad es un factor clave en la decisión respecto a si se continua o cambia el tratamiento.</li>
            <li class="text text--justify">La evaluación de la respuesta debe realizarse cada 2-4 meses para la hormonoterapia y cada 2-4 ciclos para quimioterapia.</li>
            <li class="text text--justify">El método diagnóstico a utilizar dependerá de la dinámica de la enfermedad, la localización y la extensión de la metástasis, así como del tipo de tratamiento.</li>
          </ul>
        </li>
...
HTML;
    ...
    <a href="?conozca" class="navegar__enlace">
      <span>Cáncer de Mama Localmente Avanzado</span>
