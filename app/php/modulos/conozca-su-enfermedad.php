  ...
  if ( $get->modulo("conozca") ) { 
    ...
    <div class="content__item">
      ...
      <ol class="listas listas--alfabetico listas--bold listas--secundario-2">
        <!-- a. -->
        <li>
          <p><strong class="frontal frontal--secundario-2">La Detección y Diagnóstico</strong></p>
          ...
          <ul class="listas listas--disco listas--secundario-3">
            <li class="text text--justify">Historia Clínica y Examen Físico.</li>
            <li class="text text--justify">Estudios de Imágenes de la Mama: Mamografía Bilateral. Resonancia Magnética de la Mama o Ecosonograma Mamario.</li>
            <li class="text text--justify">Hematología Completa que mide cuantitativamente los diferentes tipos de células producidas en la médula ósea; además de la  Química Sanguínea, que evalúa el funcionamiento del hígado y los riñones.</li>
            <li class="text text--justify">Biopsia de la muestra con Aguja Gruesa, que permita conocer las características histológicas y los receptores hormonales.</li>
            <li class="text text--justify">Estatificación completa, ya que las pacientes con cáncer de mama localmente avanzado tienen un riesgo significativo de enfermedad a distancia. Se debe solicitar imágenes de pulmón (Rx. De Tórax o Tomografía Axial Computarizada de Tórax), imágenes de abdomen (Ecografía Abdominal o Tomografía Axial Computarizada de Abdomen), imágenes de hueso (Gammagrama Óseo) o si existe la disponibilidad realizar un PET/TC (Tomografía por Emisión de Positrones).</li>
          </ul>
        </li>

        <!-- b. -->
        <li>
          <p><strong class="frontal frontal--secundario-2">Selección de las Opciones de Tratamiento</strong></p>

          <ol class="listas listas--romano">
            <!-- i. -->
            <li>
              <p><strong>Tratamiento Sistémico.</strong></p>
              ...
              <ul class="listas listas--circulo listas--secundario-3">
                <li>
                  ...
                  <ul class="listas listas--disco">
                    <li class="text text--justify">Medicamentos Incluidos en la lista de medicamentos esenciales de la Organización Mundial de la Salud (OMS): Doxorrubicina, Ciclofosfamida, Paclitaxel, Docetaxel, 5-Fluorouracil, Metrotexate,  Carboplatino, Gemcitabina, Capecitabina, Vinorelbine.</li>
                    <li class="text text--justify">La elección del medicamento debe basarse en la evidencia y en la disponibilidad del fármaco.</li>
                  </ul>
                </li>

                <li>
                  <p class="text text--justify">
                    <strong>Hormonoterapia.</strong> Sólo para pacientes con Receptores Hormonales Positivos. El empleo de  hormonoterapia de inicio o neoadyuvante en paciente con cáncer de mama localmente avanzado dependerá de las características del tumor (grado y otros biomarcadores) y de las características de la paciente (estado general, estado menstrual y comorbilidades).
                  </p>

                  <ul class="listas listas--disco">
                    <li class="text text--justify">Medicamentos Incluidos en la lista de medicamentos esenciales de la Organización Mundial de Salud (OMS): Tamoxifeno, Anastrozole, Leuprolide.</li>
                  </ul>
            ...
            <li>
              ...
              <p>Si posterior al tratamiento sistémico el cáncer localmente avanzado es operable:</p>

              <ul class="listas listas--disco listas--secundario-3">
                <li class="text text--justify">Mastectomía con o sin reconstrucción. La reconstrucción puede ser inmediata o diferida. No se recomienda la reconstrucción en caso de Carcinoma Inflamatorio de Mama. Va seguida de Radioterapia</li>

                <li class="text text--justify">Tratamiento Conservador de la Mama, sólo en pacientes seleccionados que hayan alcanzado una buena respuesta a la neoadyuvancia. Va seguida de Radioterapia.</li>

                <li class="text text--justify">Tratamiento de la Axila: En la gran mayoría de los casos Disección Axilar. La biopsia del Ganglio Centinela es aún controversial, sólo en indicaciones muy específicas.</li>
              </ul>

              <p>Si posterior al tratamiento sistémico el cáncer de mama  localmente avanzado es inoperable:</p>

              <ul class="listas listas--disco listas--secundario-3">
                <li class="text text--justify">Radioterapia. Considerar la cirugía posteriormente sólo si existen criterios de resecabilidad quirúrgica. <p></p></li>
              </ul>
            </li>
          </ol>
        </li>
        ...
        <!-- c. -->
        <li>
          <p><strong class="frontal frontal--secundario-2">Seguimiento Posterior a la Culminación del Tratamiento</strong></p>
          ...
          <ol class="listas listas--romano">
            <!-- i -->
            <li>
              <p><strong>Objetivos del Seguimiento a Largo Plazo</strong></p>
              <p>Los objetivos del seguimiento a largo plazo mediante las revisiones incluyen:</p>
              ...
              <ul class="listas listas--disco listas--secundario-3">
                ...
                <li>Constatar el cumplimiento de ciertos tratamientos como la terapia hormonal.</li>

                <li>
                  <p>Diagnóstico y tratamiento de posibles efectos colaterales tardíos relacionados con el tratamiento:</p>
            ...
            <!-- ii. -->
            <li>
              <p><strong>Signos y Síntomas de la Recurrencia o Recidiva Local</strong></p>
            ...
            <!-- iii. -->
            <li>
              <p><strong>Signos y Síntomas de la Recurrencia o Recidiva Regional</strong></p>
              ...
              <ul class="listas listas--disco listas--secundario-3">
                  ...
                  <li class="text text--justify">
                    <p><strong>Metas del Tratamiento en Pacientes con Recurrencia o Recidiva Locoregional</strong></p>

                    <ul class="listas listas--circulo">
                      <li>Descartar enfermedad a distancia.</li>
                      <li class="text text--justify">
