...
const encuestas = ( selector ) => {
  if ( typeof selector === "undefined" )
    ...
    boton.onclick = () => {
      ...
      modalContent.innerHTML = "<h4>En proceso de implementación</h4> <p>Ya se encuentra lista la encuensta, sin embargo, aún no se encuentra disponible en esta Web. Su implementación se realizará las próximas horas</p>";
    }
}
